      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {navOpen && (
          <div className="sm:hidden mt-2 pb-3 space-y-1">
            ...
            {user && (
              <>
                <button onClick={() => handleNavClick("/profile")} className="block w-full text-left px-4 py-2 rounded hover:bg-gray-100 dark:hover:bg-gray-800 dark:text-white">Perfil</button>
                <button onClick={() => handleNavClick("/settings")} className="block w-full text-left px-4 py-2 rounded hover:bg-gray-100 dark:hover:bg-gray-800 dark:text-white">Configurações</button>
                <button onClick={() => { setUserOpen(false); onLogout && onLogout(); }} className="block w-full text-left px-4 py-2 rounded hover:bg-gray-100 dark:hover:bg-gray-800 dark:text-white">Sair</button>
              </>
            )}
          </div>
        )}
